// Partly generated using:
// # Tags in public/index.html are copied over to here
// npx pwa-asset-generator public/favicon.ico public/pwa -x --opaque false -m public/manifest.json -i public/index.html
const PwaTags = () => {
  return (
    <>
      <meta charSet="utf-8" />
